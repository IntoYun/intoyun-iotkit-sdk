...
#ifndef __IOTX_MQTT_CLIENT_H__
#define __IOTX_MQTT_CLIENT_H__
...
typedef struct Client {
    ...
    int (*mqtt_pre_auth_process)(void);
    int (*mqtt_post_auth_process)(void);
    ...
    bool                            reconnect_open;                          /* reconnect switch */
...
#endif  /* #ifndef _IOTX_MQTT_CLIENT_API_H_ */
